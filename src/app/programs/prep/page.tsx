    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(65,105,225,0.9), rgba(0,0,0,0.8))' }}></div>
        </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4">
          ...
          <div className="text-center">
            ...
            <p className="text-2xl text-white/90 mb-6 animate-fade-in-up delay-300">Competitive Excellence</p>
            <p className="text-xl text-gray-200 max-w-3xl mx-auto leading-relaxed animate-fade-in-up delay-400">
              Beginner/intermediate level competitive program focusing on skill advancement and regional competition participation. 
              Limited travel required for competitions within the region.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-6 text-gray-700 leading-relaxed animate-fade-in-up delay-200">
                <p className="text-lg">
                  Our Prep program is designed for athletes ages 5-18 who are ready to take their competitive 
                  cheerleading to the next level. This intermediate program focuses on advanced skill development 
                  and regional competition participation.
                </p>
                <p>
                  Athletes in this program will develop more complex tumbling and stunting skills while learning 
                  advanced choreography and performance techniques. The emphasis is on competitive excellence, 
                  teamwork, and preparing for higher levels of competition.
                </p>
                <p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">1-2x per week</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">Regional</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Call to Action */}
      <section className="py-20 px-4" style={{ background: 'linear-gradient(135deg, #4169E1, #000000, #333333)' }}>
