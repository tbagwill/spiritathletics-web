            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600/50 transition-all text-gray-900 placeholder:text-gray-500" 
                  required 
                />
              </div>
              <div>
